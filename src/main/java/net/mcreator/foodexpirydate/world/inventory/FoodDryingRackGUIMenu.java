package net.mcreator.foodexpirydate.world.inventory;
...
public class FoodDryingRackGUIMenu extends AbstractContainerMenu implements FoodExpiryDateModMenus.MenuAccessor {
	...
	public FoodDryingRackGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FoodExpiryDateModMenus.FOOD_DRYING_RACK_GUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 35) {
			...
			private int x = FoodDryingRackGUIMenu.this.x;
			private int y = FoodDryingRackGUIMenu.this.y;
		}));
